...
public class ControlPanel extends VBox {
    ...
    public ControlPanel() {
        ...
        stepButton.setPrefSize(60, 50);
        stepButton.setStyle("-fx-font-size: 12px; -fx-font-weight: bold;");
    ...
    public void updateState(AlgorithmState state) {
        ...
        // Clear button should work even when algorithm is running (will reset first)
